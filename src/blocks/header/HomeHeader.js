            ...
            <div className="header-right d-flex justify-content-end">
              <div className="d-flex align-items-center">
                ...
                <MenuModal
                  buttonProps={
                    this.state.isFixed
                      ? " btn-secondary btn-hover-main-secondary "
                      : " btn-outline-tertiary btn-round "
                  }
                  buttonClass={
                    this.state.isFixed ? "adv-dark" : "adv-light mr-0"
                  }
                />
              </div>
            </div>
